...
class SimpleDiffusionTrainer(nn.Module):
    def __init__(self,
                 epoches=None,
                 train_loader=None,
                 optimizer=None,
        ...
        super(SimpleDiffusionTrainer, self).__init__(epoches, train_loader, optimizer, device, timesteps):
    ...
    def forward(self, model):
        ...
        for i in range(self.epoches):
            ...
            for step, (features, labels) in loop:
                ...
                loss = model(mode="train", x_start=features, t=t, loss_type="l2")
                losses.append(loss)
            ...
            torch.save(model.state_dict(), self.model_save_path+'BestModel.pth')
            print("model saved to" + str(self.model_save_path))
        return model